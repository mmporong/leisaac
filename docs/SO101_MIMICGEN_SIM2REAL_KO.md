...
500회 생성 완료 후 진행할 학습·평가는
[224 ACT 최신 인계](HANDOFF_ACT_VISION224_500_20260913.md)에 정리했다.

2026-09-13 공간 정리·640 렌더/224 입력 확장 진행은
[최신 인계](HANDOFF_VISION224_STORAGE_20260913.md)를 참고한다.
아래 과거 실행 절차의 관절 변환 중간 HDF5 3개는 정리되어 재변환이 필요할 수 있으며,
원본 시연·성공/실패 생성 원본·next-state 학습 데이터·모델·영상은 보존했다.
